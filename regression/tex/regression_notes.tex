...
\begin{homeworkProblem}[Derivation of Coefficient Estimates]
...
\begin{homeworkProblem}[Java Implementation]
See below in Java.

\javascript{regression}{Regression implemented in Java}
